package seccion24colecciones.tarea27.test;

import seccion24colecciones.tarea27.models.Vuelo;
...
public class TestVuelo {
    public static void main(String[] args) throws ParseException {
        ...
        llegadas.sort((a, b) -> b.getFechaLlegada().compareTo(a.getFechaLlegada()));

        System.out.println("============================================ Listado ============================================");
        System.out.printf("%-15s%-20s%-15s%-35s%s\n",
                "vuelo", "origen", "destino", "llegada", "n° pasajeros");
        llegadas.forEach(vuelo -> {
            System.out.printf("%-15s%-20s%-15s%-35s%d\n",
                    vuelo.getNombre(),
                    vuelo.getOrigen(),
                    vuelo.getDestino(),
        ...
        llegadas.sort((a, b) -> Integer.valueOf(a.getCantidadPasajeros()).compareTo(b.getCantidadPasajeros()));
        Vuelo vueloMenorCantidad = new LinkedList<>(llegadas).peekFirst();
        System.out.println("El vuelo con menor número de pasajeros es " + vueloMenorCantidad.getNombre()
                + ": " + vueloMenorCantidad.getOrigen() + ", con " + vueloMenorCantidad.getCantidadPasajeros() + " pasajeros.");

        System.out.println(vueloMenorCantidad);
    }
}
