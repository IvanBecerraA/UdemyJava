package seccion30annotations.ejemplo.procesador;

import seccion30annotations.ejemplo.Init;
import seccion30annotations.ejemplo.JsonAtributo;
import seccion30annotations.ejemplo.procesador.exception.JsonSerializadorException;
...
public class JsonSerializador {
    ...
    public static void inicializarObjeto(Object object) {
        if (Objects.isNull(object)) {
            throw new JsonSerializadorException("El objeto a seializar no puede ser nulo");
        }
